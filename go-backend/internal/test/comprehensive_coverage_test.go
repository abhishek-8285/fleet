...
func TestComprehensiveCoverage(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Get Profile", "GET", "/api/v1/profile", adminToken, nil, 200, 200},
		{"Get Users", "GET", "/api/v1/users", adminToken, nil, 200, 200},
		{"Create User", "POST", "/api/v1/users", adminToken, map[string]interface{}{
			"phone": "+919999888883",
			"role":  "driver",
			"name":  "New Test User",
		}, 201, 201},
		...
		// Analytics Coverage
		{"Get Analytics Overview", "GET", "/api/v1/analytics/overview", adminToken, nil, 200, 200},
		{"Get Driver Analytics", "GET", "/api/v1/analytics/drivers", adminToken, nil, 200, 200},
		{"Get Vehicle Analytics", "GET", "/api/v1/analytics/vehicles", adminToken, nil, 200, 200},
		{"Get Financial Analytics", "GET", "/api/v1/analytics/financial", adminToken, nil, 200, 200},

		// Location Coverage
		{"Get Locations", "GET", "/api/v1/locations", adminToken, nil, 200, 200},

		// Upload Coverage
		{"Get Uploads", "GET", "/api/v1/uploads", adminToken, nil, 200, 200},

		// Admin Coverage
		{"Get Admin Settings", "GET", "/api/v1/admin/settings", adminToken, nil, 200, 200},
		{"Get System Health", "GET", "/api/v1/admin/health", adminToken, nil, 200, 200},
